...
total_quantity_cells = len(row_1) + len(row_2) + len(row_3) + len(row_4) + len(row_5) + len(row_6) + len(row_7) + len(
    row_8) + len(row_9)
print('всего клеток с цифрами ', total_quantity_cells)
total_quantity_empty = row_1.count(0) + row_2.count(0) + row_3.count(0) + row_4.count(0) + row_5.count(0) + row_6.count(
    0) + row_7.count(0) + row_8.count(0) + row_9.count(0)
